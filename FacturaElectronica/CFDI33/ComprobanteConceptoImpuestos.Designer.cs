...
namespace FacturaElectronica.CFDI33
{
    ...
    public partial class ComprobanteConceptoImpuestos : System.ComponentModel.INotifyPropertyChanged
    {

        #region Private fields
        [EditorBrowsable(EditorBrowsableState.Never)]
        private List<ComprobanteConceptoImpuestosTraslado> _traslados;

        [EditorBrowsable(EditorBrowsableState.Never)]
        private List<ComprobanteConceptoImpuestosRetencion> _retenciones;
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializerFactory().CreateSerializer(typeof(FacturaElectronica.CFDI33.ComprobanteConceptoImpuestos));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current ComprobanteConceptoImpuestos object into an XML string
        /// </summary>
        ...
        public static bool Deserialize(string input, out ComprobanteConceptoImpuestos obj, out System.Exception exception)
        {
            exception = null;
        ...
        public static bool Deserialize(string input, out ComprobanteConceptoImpuestos obj)
        {
            System.Exception exception = null;
            return Deserialize(input, out obj, out exception);
        }

        public new static ComprobanteConceptoImpuestos Deserialize(string input)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(input);
                return ((ComprobanteConceptoImpuestos)(Serializer.Deserialize(XmlReader.Create(stringReader))));
            }
            finally
            {
        ...
        public static ComprobanteConceptoImpuestos Deserialize(System.IO.Stream s)
        {
            return ((ComprobanteConceptoImpuestos)(Serializer.Deserialize(s)));
        }
        #endregion
        ...
        public new static ComprobanteConceptoImpuestos LoadFromFile(string fileName, System.Text.Encoding encoding)
        {
