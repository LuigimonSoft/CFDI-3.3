    ...
    public partial class ComprobanteCfdiRelacionadosCfdiRelacionado : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializerFactory().CreateSerializer(typeof(FacturaElectronica.CFDI33.ComprobanteCfdiRelacionadosCfdiRelacionado));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current ComprobanteCfdiRelacionadosCfdiRelacionado object into an XML string
        /// </summary>
        ...
        public static bool Deserialize(string input, out ComprobanteCfdiRelacionadosCfdiRelacionado obj, out System.Exception exception)
        {
            exception = null;
        ...
        public static bool Deserialize(string input, out ComprobanteCfdiRelacionadosCfdiRelacionado obj)
        {
            System.Exception exception = null;
            return Deserialize(input, out obj, out exception);
        }

        public new static ComprobanteCfdiRelacionadosCfdiRelacionado Deserialize(string input)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(input);
                return ((ComprobanteCfdiRelacionadosCfdiRelacionado)(Serializer.Deserialize(XmlReader.Create(stringReader))));
            }
            finally
            {
        ...
        public static ComprobanteCfdiRelacionadosCfdiRelacionado Deserialize(System.IO.Stream s)
        {
            return ((ComprobanteCfdiRelacionadosCfdiRelacionado)(Serializer.Deserialize(s)));
        }
        #endregion
        ...
        public new static ComprobanteCfdiRelacionadosCfdiRelacionado LoadFromFile(string fileName, System.Text.Encoding encoding)
        {
