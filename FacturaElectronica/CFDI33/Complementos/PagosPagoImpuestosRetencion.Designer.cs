    ...
    public partial class PagosPagoImpuestosRetencion : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializerFactory().CreateSerializer(typeof(PagosPagoImpuestosRetencion));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current PagosPagoImpuestosRetencion object into an XML string
        /// </summary>
        ...
        public static bool Deserialize(string input, out PagosPagoImpuestosRetencion obj, out System.Exception exception)
        {
            exception = null;
        ...
        public static bool Deserialize(string input, out PagosPagoImpuestosRetencion obj)
        {
            System.Exception exception = null;
            return Deserialize(input, out obj, out exception);
        }

        public new static PagosPagoImpuestosRetencion Deserialize(string input)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(input);
                return ((PagosPagoImpuestosRetencion)(Serializer.Deserialize(XmlReader.Create(stringReader))));
            }
            finally
            {
        ...
        public static PagosPagoImpuestosRetencion Deserialize(System.IO.Stream s)
        {
            return ((PagosPagoImpuestosRetencion)(Serializer.Deserialize(s)));
        }
        #endregion
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out PagosPagoImpuestosRetencion obj, out System.Exception exception)
        {
            exception = null;
            obj = default(PagosPagoImpuestosRetencion);
            try
        ...
        public new static PagosPagoImpuestosRetencion LoadFromFile(string fileName, System.Text.Encoding encoding)
        {
